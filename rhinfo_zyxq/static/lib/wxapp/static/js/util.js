...
util.url = function (action, querystring) {
	var app = getApp();
	var apiurl = app.siteInfo.siteroot
	apiurl = apiurl.replace('index.php','miniapi.php')
	var url = apiurl + '?i=' + app.siteInfo.uniacid + '&t=' + app.siteInfo.multiid + '&v=' + app.siteInfo.version + '&from=wxapp&';
