var RhUIPicker = function (params) {
...
var RhUIDateTimePicker = function (showDate, showTime) {
    var self = this;
...
$.fn.datetimePicker = function (params) {
    ...
    return this.each(function () {
        ...
        if (!datetimePicker) {
            datetimePicker = new RhUIDateTimePicker(true, true);
...
$.fn.datePicker = function (params) {
    ...
    return this.each(function () {
        ...
        if (!datePicker) {
            datePicker = new RhUIDateTimePicker(true, false);
...
$.fn.timePicker = function (params) {
    ...
    return this.each(function () {
        ...
        if (!timePicker) {
            timePicker = new RhUIDateTimePicker(false, true);
...
var RhUIRelatePicker = function (params) {
    var self = this;
    self.allValues = [];
...
$.fn.relatePicker = function (params) {
    ...
    return this.each(function () {
        ...
        if (!relatePicker) {
            relatePicker = new RhUIRelatePicker(params);
...
$.fn.cityPicker = function (params) {
    ...
    return this.each(function () {
        ...
        if (!cityPicker) {
            cityPicker = new RhUIRelatePicker(p);
        ...
        if(params.street){
            ...
            var realData = RhUICityDataNew;
        } else {
            var realData = RhUICityData;
        }
