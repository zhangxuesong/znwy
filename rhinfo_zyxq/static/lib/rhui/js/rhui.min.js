...
(function () {
    ...
    RhUI.alert = function (text, title, callback) {

        RhUI.dialog({
            title: title,
            text: text,
            buttons: [{
                text: RhUI.defaults.confirmText,
                onclick: callback
            }]
        });
    };

    RhUI.confirm = function (text, title, confirmCallback, cancelCallback) {
    ...
    RhUI.prompt = function (text, title, placeholder, callback) {
    ...
    var RhUIModal = function (params) {
        ...
        if (mask) {
            RhUI.mask.show(maskTransparent, maskClick);
        }
    ...
    window.RhUIModal = RhUIModal;

    RhUI.dialog = function (params) {
        params = params || {};
        ...
        dialogHTML += '</div>';
        RhUI.dialog.modal = new RhUIModal({
            content: dialogHTML,
            extraClass: "dialog-modal"
        });

        RhUI.dialog.modal.show();

        $('.fui-dialog-btns a', RhUI.dialog.modal.container).each(function (index, el) {
            $(el).click(function (e) {

                RhUI.dialog.modal.close();

                if (params.buttons[index].onclick) {
                    if (params.prompt) {
                        params.buttons[index].onclick(RhUI.dialog.modal.container, RhUI.dialog.modal.container.find(':input').val(), e);
                        return;
                    }
                    params.buttons[index].onclick(RhUI.dialog.modal, e);
                }
            });
        });
        return RhUI.dialog.modal;
    };
    ...
    RhUI.loader = {
        show: function (text, iconClass, duration) {
            ...
            if (text == 'mini' || text == 'loading') {
                ...
                if (text == 'loading') {
                    loader += "<span class='fui-loader-text'>" + RhUI.defaults.loaderText + "</span>";
                }
            } else {
    ...
    RhUI.notify = {
        show: function (text, title, css, autoClose) {
            ...
            RhUI.notify.modal = new RhUIModal({
                content: notifyHTML,
                extraClass: 'notify-modal',
                mask: false
            });
            RhUI.notify.modal.show();
            RhUI.notify.modal.container.find('.fui-notify-close').click(function () {
                RhUI.notify.modal.close();
            });
    ...
    RhUI.message = {
        show: function (params) {
            ...
            RhUI.message.modal = new RhUIModal({
                content: messageHTML,
                ...
                maskClick: function () {
                    if(!btn.holdModal){
                        RhUI.message.modal.close();
                    }
                }
            });

            $('.fui-message-popup a', RhUI.message.modal.container).each(function (index, el) {
                $(el).click(function (e) {
                    ...
                    if (params.buttons) {
                        if (params.buttons[index].onclick) {
                            params.buttons[index].onclick(RhUI.message.modal, e);
                        }
                    }
                });
            });

            RhUI.message.modal.show();
        },
    ...
    var RhUIUploader = function (element, params) {
        var self = this;
        var defaults = {
            max: 1,
            uploadUrl: '',
        ...
        if (!self.params.uploadUrl) {
            console.warn('RhUI: UploadUrl not defined.');
            return;
        }
        ...
        self.file.change(function () {
            ...
            if(self.params.max>0){
                ...
                if(filecount>self.params.max){
                    RhUI.toast.show('最多上传 ' + self.params.max  + ' 张图片!');
                    return;
                }
            }
    ...
    $.fn.uploader = function (params) {
        ...
        return this.each(function () {
            ...
            if (!uploader) {
                uploader = new RhUIUploader(this, params || {});
    ...
    var RhUINumbers = function (element, params) {
        ...
        self.checkNumber = function (num) {
            ...
            if(self.params.canzero==1)
            {
                ...
                if (self.params.min > 0 && num <= self.params.min) {
                    ...
                    if (self.params.minToast && num <= self.params.min) {
                        RhUI.toast.show(self.params.minToast.replace("{min}", self.params.min));
                    }
                    num = self.params.min;
            ...
            if (self.params.max > 0 && num >= self.params.max) {
                if (self.params.maxToast && num >= self.params.max) {
                    RhUI.toast.show(self.params.maxToast.replace("{max}", self.params.max));
                }
                num = self.params.max;
    ...
    $.fn.numbers = function (params) {
        ...
        return this.each(function () {
            ...
            if (!numbers) {
                numbers = new RhUINumbers(this, params || {});
    ...
    var RhUIActionSheet = function (params) {
        var self = this;
        var cancelButton = {
            text: RhUI.defaults.cancelText,
            extraClass: 'cancel'
    ...
    RhUI.actionsheet = {
        ...
        show: function (title, buttons, round, clickClose) {
            var actionsheet = new RhUIActionSheet({
                title: title,
                buttons: buttons,
                round: round,
            ...
            $('.fui-according').each(function () {
                ...
                header.unbind("click").click(function () {
                    group.find('.fui-according').not(self).each(function () {
                        RhUI.according.collapse($(this).closest('.fui-according'));
                    });
                    if (self.hasClass('expanded')) {
                        RhUI.according.collapse(self);
                    } else {
                        RhUI.according.expand(self);
                    }
    ...
    var RhUISwipe = function (swipe, params) {
        var defaults = {
            transition: 500,
            speed: 3000,
            gap: 0,
    ...
    $.fn.swipe = function (params) {
        ...
        return this.each(function () {
            ...
            if (!swipe) {
                params = params || {};
                swipe = new RhUISwipe(this, params);
    ...
    var RhUILazyLoad = function (container, params) {
        var defaults = {
            offset: 0,
            delay: 250,
    ...
    $.fn.lazyload = function (params) {
        ...
        return this.each(function () {
            if (!this)
                return;
            var lazyload = new RhUILazyLoad(this, params);
            if (typeof params === typeof "a") {
    ...
    var RhUIStars = function (element, params) {
    ...
    $.fn.stars = function (params) {
        ...
        return this.each(function () {
            ...
            if (!stars) {
                params = params || {};
                stars = new RhUIStars(this, params);
    ...
    var RhUIPullToRefresh = function (container, params) {
        var self = this;
        self.container = $(container);
    ...
    $.fn.pullToRefresh = function (params) {
        ...
        return this.each(function () {
            ...
            if (!pulltorefresh) {
                params = params || {};
                pulltorefresh = new RhUIPullToRefresh(this, params);
    ...
    var RhUIPullToLoading = function (container, params) {
        var self = this;
        self.container = $(container);
    ...
    $.fn.pullToLoading = function (params) {
        ...
        return this.each(function () {
            ...
            if (!pulltoloading) {
                params = params || {};
                pulltoloading = new RhUIPullToLoading(this, params);
    ...
    var RhUIInfinite = function (container, params) {
        var defaults = {
            distance: 40
        };
        var self = this;
    ...
    $.fn.infinite = function (params) {
        ...
        return this.each(function () {
            ...
            if (infinite === undefined) {
                infinite = new RhUIInfinite(this, params || {});
    ...
    var RhUITimer = function (container, params) {
        var defaults = {
            startLabel: "距离开始",
            endLabel: "距离结束",
            endText: "活动已结束",
    ...
    $.fn.timer = function (params) {
        ...
        return this.each(function () {
            ...
            if (!timer) {
                timer = new RhUITimer(this, params || {});
    ...
    var Util = {
        ...
        supportStorage: function () {
            var mod = 'rhui.router.storage.ability';
            try {
    ...
    var Router = function () {
        this.sessionNames = {
            currentState: 'rhui.router.currentState',
            maxStateId: 'rhui.router.maxStateId'
        };
...
//                }
    ...
    function customClickFilter($link) {
        var customRouterFilter = RhUI.defaults.routerFilter;
...
/*
        ...
        if (userAgent.indexOf('CK 2.0') <= -1){
            ...
            $(document).on('click', 'a', function (e) {
                ...
                if ($target.hasClass('back')) {
                    ...
                    RhUI.router.load(url, ignoreCache);
                }
            });
    ...
    if (RhUI.defaults.routerShowLoading) {
