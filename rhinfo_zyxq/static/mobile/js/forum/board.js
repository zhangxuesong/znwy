define(['core', 'tpl'], function(core, tpl) {
	...
	modal.bindPostEvents = function() {
		...
		$('#uploadimages1').click(function(){				
			core.wxUploadImages($(this),"myimages1",core.getUrl('util/wxuploader')+'&nodisplay=1',core.getUrl('util/remove'));	
		});
		
		$('#uploadimages2').click(function(){				
			core.wxUploadImages($(this),"myimages2",core.getUrl('util/wxuploader')+'&nodisplay=1',core.getUrl('util/remove'));	
		});
	};
	...
	modal.initSelect = function(params) {
		$('#btnSubmit').click(function(){			
			var selectboard = $("#boardid").val();
			if(selectboard==''){
			   RhUI.toast.show('版块不能为空');
			   return
			}
			$("#myform").submit();			
		});
	...
	modal.bindVoiceEvents = function() {
