...
$mywe = $this->mywe;
$mydo = 'redpacket';
$tablename = 'rhinfo_zycj_redpacket';
$condition = ' weid = :weid';
...
if ($operation == 'list') {
    ...
    $current = '新增红包';
    if ($_W['ispost']) {
        $data = array('weid' => $mywe['weid'], 'pid' => $_GPC['pid'], 'rid' => $_GPC['rid'], 'title' => $_GPC['title'], 'sendtype' => $_GPC['sendtype'], 'category' => $_GPC['category'], 'amount' => $_GPC['amount'], 'minamount' => $_GPC['minamount'], 'maxamount' => $_GPC['maxamount'], 'totalnum' => $_GPC['totalnum'], 'sumamount' => $_GPC['sumamount'], 'from' => $_GPC['from'], 'wishing' => $_GPC['wishing'], 'remark' => $_GPC['remark'], 'status' => $_GPC['status'], 'cuid' => $mywe['uid'], 'ctime' => TIMESTAMP);
    ...
    $id = intval($_GPC['id']);
    if ($_W['ispost']) {
        $data = array('pid' => $_GPC['pid'], 'rid' => $_GPC['rid'], 'title' => $_GPC['title'], 'sendtype' => $_GPC['sendtype'], 'category' => $_GPC['category'], 'amount' => $_GPC['amount'], 'minamount' => $_GPC['minamount'], 'maxamount' => $_GPC['maxamount'], 'totalnum' => $_GPC['totalnum'], 'sumamount' => $_GPC['sumamount'], 'from' => $_GPC['from'], 'wishing' => $_GPC['wishing'], 'remark' => $_GPC['remark'], 'status' => $_GPC['status']);
        $glue = 'AND';
